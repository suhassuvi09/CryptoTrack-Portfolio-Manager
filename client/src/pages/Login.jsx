          ...
          <div className="relative h-full flex flex-col justify-center items-center text-white p-12">
            <div className="text-center">
              ...
              <p className="text-xl mb-8 opacity-90">
                Monitor real-time prices, manage your holdings, and analyze your portfolio performance with CryptoTrack.
              </p>
              <div className="grid grid-cols-2 gap-6 text-center">
                <div>
                  <div className="text-3xl font-bold">1000+</div>
                  <div className="text-sm opacity-80">Cryptocurrencies</div>
                </div>
                <div>
                  <div className="text-3xl font-bold">Real-time</div>
                  <div className="text-sm opacity-80">Price Updates</div>
                </div>
                <div>
